...
ALTER TABLE TB_ProductSubCategory ADD CONSTRAINT FK_ProductTopCategory_ProductSubCategory FOREIGN KEY (ProductTopCategoryID) REFERENCES TB_ProductTopCategory(ProductTopCategoryID);